...
Phylum <- Tax.sum(sQinLC, sTAXA, 5) %>% 
  t() %>% 
  as.data.frame() %>% 
  mutate(Color = c("#004146", "#4E0066", "#007F5F", "#359548", "#F94144", "#16DB93", "#6AAB30", "#F1F500", "#83E377", "#BACC0C", "#FA8072", "#F97100", "#410151", "#FA776B", "#176EA8", "#F8417D", "#F95C74", "#31AF78", "#ACDD3C", "#FB9C70", "#C5DBEA", "#000000", "#8BB7D4", "#5193BE", "#AA006A", "#00609F", "#023E8A", "#000078", "#161664", "#17315F", "#0B0B30", "#FF0000", "#CC0000", "#9B2226", "#4E1114"))
