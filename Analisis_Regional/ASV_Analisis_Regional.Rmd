...
TAXA <- read.csv("/Documents/GitHub/CORE/DADA2_Regional/taxa.csv", 
                 header = TRUE, 
                 sep = ";", 
                 skip = 0) %>% 
  dplyr::rename(Seq = X) %>% 
  add_column(ASV = c(str_glue("ASV000{1:9}"),str_glue("ASV00{10:99}"),str_glue("ASV0{100:999}"),str_glue("ASV{1000:6191}")), .after = "Seq")
