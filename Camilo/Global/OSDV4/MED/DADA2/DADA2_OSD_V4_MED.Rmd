...
path <- "X:/Documents/Proyectos_R/OSD/NeoV4/MED/"
fns <- list.files(path)
...
out <- filterAndTrim(fnFs, filtFs, fnRs, filtRs, 
                     truncLen = c(230,220), trimLeft = c(10,10),
                     maxN = 0, maxEE = c(2,2), truncQ = 2, 
                     compress = TRUE, multithread = FALSE, verbose = TRUE)
rinout <- as.data.frame(out)
write.csv2(rinout, file = "/Documents/GitHub/CORE/Camilo/Global/OSDV4/MED/DADA2/reads_out.csv")
proc.time() - ptm
```
...
write.csv2(trackdf, "/Documents/GitHub/CORE/Camilo/Global/OSDV4/MED/DADA2/process_check.csv")
...
write.csv2(s_tab, "/Documents/GitHub/CORE/Camilo/Global/OSDV4/MED/DADA2/summary_tab_dada2.csv")
```

```{r echo=TRUE,message=FALSE,warning=FALSE}
seqtab.nochim <- seqtab.nochim[, colSums(seqtab.nochim)>10]
write.csv2(seqtab.nochim, "/Documents/GitHub/CORE/Camilo/Global/OSDV4/MED/DADA2/seqtab_nonchim_med.csv")
```
...
taxa <- assignTaxonomy(seqtab.nochim, 
                       ...
                       multithread = TRUE)
write.csv2(taxa, "/Documents/GitHub/CORE/Camilo/Global/OSDV4/MED/DADA2/taxa_osd_v4_med.csv")
```
...
write(asv_fasta, "/Documents/GitHub/CORE/Camilo/Global/OSDV4/MED/DADA2/seqs_OSD_V4_MED.fasta") #Will be send to dropbox, not sure if push to dataset repository

#count table
asv_tab <- t(seqtab.nochim) %>% as.data.frame()
rownames(asv_tab) <- sub(">", "", asv_headers)
colnames(asv_tab) <- c("OSD014", "OSD022", "OSD099", "OSD049", "OSD0076", "OSD077", "OSD123", "OSD132")
asv_tab <- mutate(asv_tab, Seqs = all_of(colnames(seqtab.nochim)), .before = "OSD014")
write.csv2(asv_tab, file = "/Documents/GitHub/CORE/Camilo/Global/OSDV4/MED/DADA2/ASV_counts_OSD_V4_MED.csv")
```
