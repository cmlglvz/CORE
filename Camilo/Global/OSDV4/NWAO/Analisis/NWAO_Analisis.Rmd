...
rownames(NWAO) <- samples
write.csv2(NWAO, "NWAO_ASV_Abundance.csv")

TAXA <- read.csv("/Users/Artemis/Documents/GitHub/CORE/Camilo/Global/OSDV4/NWAO/DADA2/taxa_osd_v4_nwao.csv", 
                 header = TRUE, 
                 sep = ";", 
                 skip = 0) %>% 
  dplyr::rename(Seq = X) %>%
  add_column(ASV = c(str_glue("ASV000{1:9}"), 
                     ...
                     str_glue("ASV0{100:924}")), 
             .after = "Seq")
rownames(TAXA) <- TAXA[,1]
write.csv2(TAXA, "OSD_V4_NWAO_TAXA.csv")

print(all(colnames(NWAO)%in%rownames(TAXA))) #If TRUE you can continue
```
...
write.csv2(mTAXA, "Filtered_NWAO_TAXA.csv")
mNWAO <- dplyr::select(NWAO, -all_of(na.seq))
write.csv2(mNWAO, "Filtered_NWAO_ASV_Abundance.csv")

print(all(colnames(mNWAO)%in%rownames(mTAXA))) #If TRUE you can continue
```


#Rarefacción
```{r Rarefaction, echo=TRUE, message=TRUE, warning=TRUE}
rare.all <- sort(rowSums(mNWAO)) #To identify the sample with the smallest number of observations, which will be used as the number of observations to rarefy samples

rrfy <- rarefy(mNWAO, rare.all[1]) #rarefaction use the smallest number of observations per sample to extrapolate the expected number if all other samples only had that number of observations
...
png("/Users/Artemis/Documents/GitHub/CORE/Camilo/Global/OSDV4/NWAO/Imagenes/Rarecurve_mNWAO.png", width = 12, height = 6, units = "in", res = 300)
par(mar = c(5.1, 4.1, 4.1, 2.1), oma = c(0, 0, 0, 0))
rarecurve(x = mNWAO, col = "blue", lwd = 2, las = 1, label = TRUE, step = 10, cex = 0.5)
dev.off()

rareNWAO <- as.data.frame(rrarefy(mNWAO, rrfy[1]))
write.csv2(rareNWAO, file = "Rarefacted_filt_NWAO_ASV_Abundance.csv")
```


#Unify abundance and taxonomic dataframes
```{r}
Union <- as.data.frame(t(mNWAO))
Union <- mutate(Union, Seq = all_of(rownames(Union)), .before = "OSD143")
Union <- mutate(Union, 
                Total = rowSums(Union[2:8])
                )
ATs <- inner_join(Union, mTAXA, by = "Seq") %>% relocate(ASV, .after = Seq)
rownames(ATs) <- all_of(ATs[,1])
write.csv2(ATs, "Taxonomic_and_Abundance_NWAO.csv")
```
...
asv <- ATs[,2]
edited <- ATs[, -c(2,10:18)]
rownames(edited) <- asv
write.csv2(edited, "edited_Taxonomic_and_Abundance_NWAO.csv")
APATs <- edited[, -1]
APATs <- vegan::decostand(APATs, method = "pa")
APATs <- add_column(APATs, Seq = all_of(edited$Seq), .before = "OSD143")
write.csv2(APATs, "Absence_Presence_NWAO.csv")
```


#Complete UpSet
```{r Complete, echo=TRUE, message=TRUE, warning=TRUE}
aus.pres <- read.csv("Absence_Presence_NWAO.csv", 
                     header = TRUE, 
                     sep = ";", 
                     dec = ".", 
                     skip = 0)

png("/Users/Artemis/Documents/GitHub/CORE/Camilo/Global/OSDV4/NWAO/Imagenes/Complete_UpSet.png", width = 40, height = 17, units = "in", res = 200)
upset(aus.pres, 
      nsets = 6, 
      nintersects = NA, 
      sets = c("OSD143", "OSD037", "OSD039", "OSD060", "OSD054", "OSD055", "OSD152"), 
...
png("/Users/Artemis/Documents/GitHub/CORE/Camilo/Global/OSDV4/NWAO/Imagenes/Shorter_UpSet.png", width = 30, height = 13, units = "in", res = 200)
upset(aus.pres, 
      nsets = 6,
      nintersects = NA, 
      sets = c("OSD143", "OSD055", "OSD054", "OSD060", "OSD039", "OSD037", "OSD152"), 
      intersections = list("OSD143", "OSD055", "OSD054", "OSD060", "OSD039", "OSD037", "OSD152", 
                           list("OSD055", "OSD054"), 
                           list("OSD143", "OSD039"), 
                           list("OSD143", "OSD060"), 
                           list("OSD039", "OSD060"), 
                           list("OSD054", "OSD055", "OSD152"), 
                           list("OSD143", "OSD039", "OSD060"), 
                           list("OSD143", "OSD037", "OSD039"), 
                           list("OSD143", "OSD037", "OSD039", "OSD060"), 
                           list("OSD143", "OSD055", "OSD054", "OSD060", "OSD039", "OSD037", "OSD152")
                           ),
      empty.intersections = "on", 
      keep.order = TRUE, 
      query.legend = "top", 
...
Phylum <- Tax.sum(mNWAO, mTAXA, 5) %>% 
  t() %>% 
  as.data.frame() %>% 
  dplyr::mutate(Color = c("#60F649", "#FDFBE3", "#24F205", "#FDFBE3", "#88F877", "#FDFBE3", "#FDFBE3", "#FDFBE3", "#FDFBE3", "#000000", 
                          "#FDFBE3", "#AFFAA4", "#FDFBE3", "#C8FBC1", "#FDFBE3", "#FDFBE3", "#FDFBE3", "#FDFBE3", "#88F877", "#FDFBE3", 
                          "#FBFDE3", "#000000", "#FDFBE3", "#FDFBE3", "#FDFBE3", "#FDFBE3", "#E0FDDC", "#FDFBE3", "#FDFBE3", "#FDFBE3", 
                          "#FDFBE3", "#FDFBE3", "#FDFBE3", "#FDFBE3")
                )
Phylum <- dplyr::mutate(Phylum, 
                        Total = rowSums(Phylum[1:7]), 
                        .after = "OSD152")
Phylum <- Phylum[order(Phylum$Total, decreasing = TRUE),]
write.csv2(Phylum, "Phylum_NWAO_Abundance_and_color.csv")
```


```{r phylum visualization, echo=TRUE,message=TRUE,warning=TRUE}
png("/Users/Artemis/Documents/GitHub/CORE/Camilo/Global/OSDV4/NWAO/Imagenes/Fig_4_Contribution_Distribution_Phylum.png", width = 17, height = 15, units = "in", res = 300)
treemap::treemap(read.csv("Phylum_NWAO_Abundance_and_color.csv", 
                          header = TRUE, 
                          sep = ";", 
                          dec = ".", 
                          skip = 0), 
...
png("/Users/Artemis/Documents/GitHub/CORE/Camilo/Global/OSDV4/NWAO/Imagenes/Fig_4_Legend.png", width = 10, height = 7, units = "in", res = 300)
plot.new()
par(mar = c(0,0,0,0), oma = c(0,0,0,0))
legend("center", 
       legend = read.csv("Phylum_NWAO_Abundance_and_color.csv", 
                         header = TRUE, 
                         sep = ";", 
                         dec = ".", 
                         skip = 0)[,1], 
...
```{r}
rltv.abun <- rltv.Otu.Table(Tax.sum(mNWAO, mTAXA, 5)) %>% as.data.frame()
write.csv2(rltv.abun, "NWAO_Relative_Abundance_dataframe.csv")
```


```{r}
png("/Users/Artemis/Documents/GitHub/CORE/Camilo/Global/OSDV4/NWAO/Imagenes/Fig_5_NWAO_Relative_Abundance.png", width = 30, height = 11, units = "in", res = 300)
par(mar = c(5.1,4.1,4.1,2.1), oma = c(0,0,0,0))
barplot(t(rltv.abun), 
        border = NA, 
        ...
        ylim = c(0,1), 
        axes = TRUE, 
        col = c("#60F649", "#FDFBE3", "#24F205", "#FDFBE3", "#88F877", "#FDFBE3", "#FDFBE3", "#FDFBE3", "#FDFBE3", "#000000", 
                "#FDFBE3", "#AFFAA4", "#FDFBE3", "#C8FBC1", "#FDFBE3", "#FDFBE3", "#FDFBE3", "#FDFBE3", "#88F877", "#FDFBE3", 
                "#FBFDE3", "#000000", "#FDFBE3", "#FDFBE3", "#FDFBE3", "#FDFBE3", "#E0FDDC", "#FDFBE3", "#FDFBE3", "#FDFBE3", 
                "#FDFBE3", "#FDFBE3", "#FDFBE3", "#FDFBE3"), 
        las = 2, 
...
png("/Users/Artemis/Documents/GitHub/CORE/Camilo/Global/OSDV4/NWAO/Imagenes/Fig_5_Legend.png", width = 3, height = 5, units = "in", res = 300)
plot.new()
par(mar = c(0,0,0,0), oma = c(0,0,0,0))
legend("center", 
       ...
       cex = 1, 
       ncol = 1, 
       fill = c("#60F649", "#FDFBE3", "#24F205", "#FDFBE3", "#88F877", "#FDFBE3", "#FDFBE3", "#FDFBE3", "#FDFBE3", "#000000", 
                "#FDFBE3", "#AFFAA4", "#FDFBE3", "#C8FBC1", "#FDFBE3", "#FDFBE3", "#FDFBE3", "#FDFBE3", "#88F877", "#FDFBE3", 
                "#FBFDE3", "#000000", "#FDFBE3", "#FDFBE3", "#FDFBE3", "#FDFBE3", "#E0FDDC", "#FDFBE3", "#FDFBE3", "#FDFBE3", 
                "#FDFBE3", "#FDFBE3", "#FDFBE3", "#FDFBE3"), 
       x.intersp = 0.1, 
...
write.csv2(ppe.taxa, "/Users/Artemis/Documents/GitHub/CORE/Camilo/Global/OSDV4/NWAO/Analisis/PPE/NWAO_PPE_TAXA.csv")
ppe.nwao <- select(mNWAO, all_of(ppe.taxa$Seq))
write.csv2(ppe.nwao, "/Users/Artemis/Documents/GitHub/CORE/Camilo/Global/OSDV4/NWAO/Analisis/PPE/NWAO_PPE_ASV_Abundance.csv")
ppe.un <- as.data.frame(t(ppe.nwao)) %>% dplyr::mutate(Seq = all_of(ppe.taxa$Seq), .before = "OSD143")
ppe.un <- mutate(ppe.un, 
                 Total = rowSums(ppe.un[2:8])
                 )
ppe.at <- inner_join(ppe.un, ppe.taxa, by = "Seq") %>% relocate(ASV, .after = Seq)
rownames(ppe.at) <- all_of(ppe.at[,1])
write.csv2(ppe.at, "/Users/Artemis/Documents/GitHub/CORE/Camilo/Global/OSDV4/NWAO/Analisis/PPE/Taxonomic_and_Abundance_PPE.csv")
```


```{r}
verdes <- ppe.at[,2]
vedited <- ppe.at[, -c(2,10:18)]
rownames(vedited) <- verdes
write.csv2(vedited, "/Users/Artemis/Documents/GitHub/CORE/Camilo/Global/OSDV4/NWAO/Analisis/PPE/edited_taxonomic_and_abundance_PPE.csv")
ppe.apats <- vedited[,-1]
ppe.apats <- vegan::decostand(ppe.apats, method = "pa") %>% add_column(Seq = all_of(vedited$Seq), .before = "OSD143")
write.csv2(ppe.apats, "/Users/Artemis/Documents/GitHub/CORE/Camilo/Global/OSDV4/NWAO/Analisis/PPE/Absence_Presence_PPE.csv")
```


#PPE UpSet
```{r}
aps.ppe <- read.csv2("/Users/Artemis/Documents/GitHub/CORE/Camilo/Global/OSDV4/NWAO/Analisis/PPE/Absence_Presence_PPE.csv", 
                     header = TRUE, 
                     sep = ";", 
                     dec = ".", 
                     skip = 0)

png("/Users/Artemis/Documents/GitHub/CORE/Camilo/Global/OSDV4/NWAO/Imagenes/PPE/Fig_6_Complete_PPE_UpSet.png", width = 40, height = 17, units = "in", res = 200)
upset(aps.ppe, 
      nsets = 6, 
      nintersects = NA, 
      sets = c("OSD152", "OSD037", "OSD039", "OSD060", "OSD054", "OSD055", "OSD143"), 
      empty.intersections = "on", 
      point.size = 3.5, 
      line.size = 1.5, 
      text.scale = 2, 
...
png("/Users/Artemis/Documents/GitHub/CORE/Camilo/Global/OSDV4/NWAO/Imagenes/PPE/Fig_7_Shorter_NWAO_PPE_UpSet.png", width = 30, height = 13, units = "in", res = 200)
upset(aps.ppe, 
      nsets = 7,
      nintersects = NA, 
      sets = c("OSD152", "OSD037", "OSD039", "OSD060", "OSD054", "OSD055", "OSD143"), 
      intersections = list("OSD152", "OSD037", "OSD039", "OSD060", "OSD054", "OSD055", "OSD143", 
                           list("OSD054", "OSD055"), 
                           list("OSD039", "OSD143"), 
                           list("OSD054", "OSD055", "OSD152"), 
                           list("OSD039", "OSD060", "OSD143"), 
                           list("OSD152", "OSD037", "OSD039", "OSD060", "OSD054", "OSD055", "OSD143")
                           ),
      empty.intersections = "on", 
      keep.order = TRUE, 
      query.legend = "top", 
