...
png("/Documents/GitHub/CORE/Camilo/Global/OSDV4/Figuras/Fig_2_Contribution_Distribution_Phylum_OSDV4.png", width = 17, height = 15, units = "in", res = 600)
treemap::treemap(read.csv("Phylum_OSDV4_Abundance_and_color.csv", 
                          header = TRUE, 
                          sep = ";", 
                          dec = ".", 
                          skip = 0), 
...
png("/Documents/GitHub/CORE/Camilo/Global/OSDV4/Figuras/Fig_2_Legend.png", width = 10, height = 7, units = "in", res = 600)
plot.new()
par(mar = c(0,0,0,0), oma = c(0,0,0,0))
legend("center", 
       legend = read.csv("Phylum_OSDV4_Abundance_and_color.csv", 
                         header = TRUE, 
                         sep = ";", 
                         dec = ".", 
                         skip = 0)[,1], 
