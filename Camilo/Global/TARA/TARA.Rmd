...
png("/Documents/GitHub/CORE/Camilo/Global/TARA/Figuras/Fig_2_Contribution_Distribution_Phylum_Total_ASV.png", width = 17, height = 15, units = 'in', res = 600)
treemap(read.csv("/Documents/GitHub/CORE/Camilo/Global/TARA/Phylum_TARA_Abundance_and_Color.csv", 
                 header = TRUE, 
                 sep = ";", 
                 dec = ".", 
                 skip = 0), 
...
legend("center", 
       legend = read.csv("/Documents/GitHub/CORE/Camilo/Global/TARA/Phylum_TARA_Abundance_and_Color.csv", 
                         header = TRUE, 
                         sep = ";", 
                         dec = ".", 
                         skip = 0)[,1], 
...
```{r}
PPE <- PhyCol[c(4,7,12,13,23,26),]
write.csv2(PPE, "/Documents/GitHub/CORE/Camilo/Global/TARA/TARA_PPE_Abundance_and_Color.csv")

png("/Documents/GitHub/CORE/Camilo/Global/TARA/Figuras/Fig_4_Contribution_Distribution_Phylum_Total_ASV.png", width = 17, height = 15, units = 'in', res = 600)
