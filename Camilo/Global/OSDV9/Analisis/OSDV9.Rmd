...
png("/Documents/GitHub/CORE/Camilo/Global/OSDV9/Figuras/Fig_3_Contribution_Distribution_Phylum_OSDV9.png", width = 17, height = 15, units = "in", res = 600)
treemap::treemap(read.csv("Phylum_OSDV9_Abundance_and_color.csv", 
                          header = TRUE, 
                          sep = ";", 
                          dec = ".", 
                          skip = 0), 
                 ...
                 fontsize.labels = 20, 
                 fontsize.title = 30, 
                 title = "Sequence/ASV distribution and contribution at phylum level", 
                 title.legend = NA, 
                 border.col = NA
                 )
dev.off()

png("/Documents/GitHub/CORE/Camilo/Global/OSDV9/Figuras/Fig_3_Legend.png", width = 10, height = 7, units = "in", res = 600)
plot.new()
par(mar = c(0,0,0,0), oma = c(0,0,0,0))
legend("center", 
       legend = read.csv("Phylum_OSDV9_Abundance_and_color.csv", 
                         header = TRUE, 
                         sep = ";", 
                         dec = ".", 
                         skip = 0)[,1], 
