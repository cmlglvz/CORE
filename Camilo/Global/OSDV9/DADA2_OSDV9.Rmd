...
path <- "X:/Documents/Proyectos_R/OSD/V9/"
fns <- list.files(path)
fastqs <- fns[grepl(".fastq.gz", fns)]
fastqs <- sort(fastqs)
fnFs <- fastqs[grepl("_R1_18S_V9_lw_raw.fastq.gz", fastqs)]
fnRs <- fastqs[grepl("_R2_18S_V9_lw_raw.fastq.gz", fastqs)]
...
out <- filterAndTrim(fnFs, filtFs, fnRs, filtRs, 
                     truncLen = c(130,120), trimLeft = c(10,10),
                     maxN = 0, maxEE = c(2,2), truncQ = 2, 
                     compress = TRUE, multithread = FALSE, verbose = TRUE)
rinout <- as.data.frame(out)
write.csv2(rinout, file = "/Documents/GitHub/CORE/Camilo/Global/OSDV9/reads_out_v9.csv")
proc.time() - ptm
```
...
write.csv2(trackdf, "/Documents/GitHub/CORE/Camilo/Global/OSDV9/process_check_v9.csv")
...
write.csv2(s_tab, "/Documents/GitHub/CORE/Camilo/Global/OSDV9/summary_tab_dada2_v9.csv")
```

```{r echo=TRUE,message=FALSE,warning=FALSE}
seqtab.nochim <- seqtab.nochim[, colSums(seqtab.nochim)>10]
write.csv2(seqtab.nochim, "/Documents/GitHub/CORE/Camilo/Global/OSDV9/seqtab_nonchim_v9.csv")
```
...
taxa <- assignTaxonomy(seqtab.nochim, 
                       ...
                       multithread = TRUE)
write.csv2(taxa, "/Documents/GitHub/CORE/Camilo/Global/OSDV9/taxa_osd_v9.csv")
```
