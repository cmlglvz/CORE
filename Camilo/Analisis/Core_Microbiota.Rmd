...
det.string <- add_column(det.string, Site = rownames(det.string), .before = "Unique", .name_repair = "minimal")
det.string <- det.string[,-5]
...
dslong <- gather(det.string, "Type", "Abundance", 2:4)
```
...
ggsave(plot = detsng, 
       filename = "fig_d_stringent_relative_contribution_asv_type.png", 
       path = "./Figuras/", 
       width = 12, 
       height = 15, 
       dpi = 400)
